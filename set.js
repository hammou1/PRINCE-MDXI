...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~ERgzRqF7oKeKLjvLPp0r", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "212621380298", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "212621380298", // Only 1 owner Number Here, others Add to sudo numbers...
